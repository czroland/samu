...
After that you can compile the project, in project's directory tpye the following, where
 /home/username/link-grammar-5.2.5/ is your link-grammar's  directory, the version could be other (5.3.1 or 5.3.2), type your version

javac -cp /home/username/link-grammar-5.2.5/bindings/java/linkgrammar-5.2.5.jar *.java

For running, `pwd` because of simbolyc links, if the program gives to you out of heap memory
